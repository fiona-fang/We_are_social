...
STRIPE_PUBLISHABLE = os.getenv('STRIPE_PUBLISHABLE', 'pk_test_uPOgyxt12Z8gmV6Rt0ONYg30')
STRIPE_SECRET = os.getenv('STRIPE_SECRET', 'sk_test_Xj9IWleEulfipuqcA3fbevlL')
